...
class CityPickerView: UIPickerView, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    weak var cDelegate: CityPickerViewDelegate?
    
    func initData(defaultValue : [String] = []){
        self.delegate = self
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        finalValue = province + " " + city + " " + area
        cDelegate?.callback(self, province: province, city: city, area: area)
    }
