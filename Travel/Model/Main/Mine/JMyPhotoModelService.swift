...
class JMyPhotoModelService: NSObject {
    func getMyPhoto(page: Int, keyboard: String?, criteria: String?, orderby: String?, callback: @escaping ([Message]?, String?)->()) {
        let request = JMyPhotoRequestModel(pageNum: page, criteria: criteria ?? "", keyword: keyboard ?? "", orderBy: orderby ?? "")
