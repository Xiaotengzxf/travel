...
class JForgetPWDModelService: NSObject {
    ...
    weak var presenter: JForgetPWDPresenterDelegate?
    
    init(presenter: JForgetPWDPresenterDelegate) {
        super.init()
...
extension JForgetPWDModelService: JForgetPWDModelServiceDelegate {
